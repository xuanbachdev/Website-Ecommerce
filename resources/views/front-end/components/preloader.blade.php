    ...
    <div id="preloader">
        <div id="ctn-preloader" class="ctn-preloader">
            <div class="animation-preloader">
                <div class="icon"><img src="{{ asset('frontend/images/1.svg') }}" alt=""></div>
                <div class="txt-loading">
                    ...
                    <span data-text-preloader="Â" class="letters-loading">
									Â
								</span>
                    ...
                    <span data-text-preloader="Á" class="letters-loading">
									Á
								</span>
...
<section>
    <div id="overlay-loading" style="display: none">
        <div id="ctn-loading" class="ctn-preloader">
            <div class="animation-preloader">
                <div class="icon"><img src="{{ asset('frontend/images/1.svg') }}" alt="" /></div>
            </div>
        </div>
...
<!-- ajaxchimp -->
<script src="{{ asset('frontend/vendor/ajaxchimp/jquery.ajaxchimp.min.js') }}"></script>
<!-- Fancybox -->
<script src="{{ asset('frontend/vendor/fancybox/dist/jquery.fancybox.min.js') }}"></script>
<!-- Tilt js -->
<script src="{{ asset('frontend/vendor/tilt.jquery.js') }}"></script>
